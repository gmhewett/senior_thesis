// <copyright file="ManageController.cs" company="The Reach Lab, LLC">
...
namespace Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        private EpiFibSignInManager signInManager;
        ...
        public ManageController(EpiFibUserManager userManager, EpiFibSignInManager signInManager)
        {
        ...
        public EpiFibSignInManager SignInManager
        {
            get
            {
                return this.signInManager ?? HttpContext.GetOwinContext().Get<EpiFibSignInManager>();
            }
        ...
        public EpiFibUserManager UserManager
        {
            get
            {
                return this.userManager ?? HttpContext.GetOwinContext().GetUserManager<EpiFibUserManager>();
            }
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.AddPhoneSuccess ? "Your phone number AuthenticationManagerwas added."
