// <copyright file="CultureHelper.cs" company="The Reach Lab, LLC">
...
namespace Web.Helpers
{
    ...
    public sealed class CultureHelper
    {
        ...
        public static CultureInfo GetClosestCulture(string cultureName)
        {
            ...
            string neutralCultureName = GetNeutralCultureName(cultureName);
            ...
            string closestCultureName = ImplementedCultureNames.FirstOrDefault(
                culture => culture.StartsWith(neutralCultureName, StringComparison.Ordinal));
        ...
        public static CultureInfo GetDefaultCulture()
        {
            ...
            return ImplementedCultureNames.Any(x => x.Equals(defaultCulture, StringComparison.InvariantCultureIgnoreCase)) ? new CultureInfo(defaultCulture) : new CultureInfo(ImplementedCultureNames.First());
        }
